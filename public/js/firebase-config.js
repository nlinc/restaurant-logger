...
const firebaseConfig = {
  apiKey: "AIzaSyDfMC08nUcjpt84bjrCGPP5yXbRjTi_huQ",
...
export { collection, addDoc, doc, updateDoc, getDoc, serverTimestamp, query, where, orderBy, limit, onSnapshot, getDocs, signInWithPopup, signOut, onAuthStateChanged, httpsCallable };
